...
export default function TermsContainer() {
  const testimonials = [
    ...
    },
    {
      ...
      description: `2. Intellectual Property
      ...
      Our Service may contain links to third-party websites or services that are not owned or controlled by MyIEP Buddy, LLC.
      MyIEP Buddy, LLC has no control over and assumes no responsibility for the content, privacy policies, or practices of any third-party websites or services. We do not warrant the offerings of any of these entities/individuals or their websites.
