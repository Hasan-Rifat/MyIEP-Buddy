        ...
        <div className=" bg-[#F7F9FA] z-[-10] overflow-hidden">
            <div className=" container xl:px-20 px-5 mx-auto lg:flex sm:py-40 py-32 relative">
                <div className=" lg:w-1/2 relative z-[10]">
                    <h1 className=" 2xl:text-[68px]  2xl:leading-[96px] lg:leading-[72px] md:leading-[72px] sm:text-6xl text-5xl font-bold text-black  mb-7"><span className=" text-[#FFAAA9]">Never struggle with </span>writing an IEP ever again.</h1>
                    <p className=" text-[#868686] text-[18px] w-4/5 mb-8 ">You have enough going on. Make your life easier with MyIEP Buddy–your own IEP writing assistant!</p>
                    <button className=" py-2 px-7 bg-[#A9F8FD] rounded-lg">GET STRATED</button>
                ...
                <div className=" lg:w-1/2 z-[100] relative xl:pb-5 lg:pb-0 pb-5 mt-10 lg:mt-0">
                    <Image
                        ...
                        className=" w-full  "
                    />
                    <div className=" w-full xl:h-full lg:h-[90%] h-full bg-[#A9F8FD] rounded-[40px] absolute top-0 left-0 z-[-1]">
                    </div>
                </div>
