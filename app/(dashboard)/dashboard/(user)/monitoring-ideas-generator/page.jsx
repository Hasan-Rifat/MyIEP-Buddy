...
export default function Page() {
  ...
  return (
    <div className=" min-h-screen  bg-[#F2F2F2]  sm:px-10 px-2 pt-5 lg:flex items-center gap-10">
      {update && (
        <div className=" flex flex-col items-center  lg:w-2/6   mb-10 transition-all duration-200 ease-out">
          ...
          <h1 className=" text-[#616161] font-medium text-2xl mt-5 mb-3">
            Progress Monitoring Ideas Generator
          </h1>
      ...
      <div
        className={` ${
          update ? "lg:w-4/6 w-full" : "w-full"
        } bg-white  mb-10  py-12 px-7 rounded-3xl`}
      >
          ...
          <div className=" flex flex-col items-end ">
            <li
              class={`flex  items-center before:content-[''] before:w-10 before:h-1 before:border-b  before:border-4 before:inline-block before:rounded-r-full ${
                update ? "before:border-[#555555]" : " before:border-[#A9F8FD]"
              } `}
            >
              <span
            ...
            <h1
              className={` font-medium ${
                update ? "text-[#555555]" : "text-[#A9F8FD]"
              } `}
            >
              Result
            </h1>
        ...
        {update ? (
          <from>
            <div>
              <label
                className=" text-[#5F5F5F] text-xl font-medium "
                htmlFor="goal"
              >
                Goal
              </label>
            ...
            <div className=" mt-4">
              <h1 className=" text-[#5F5F5F] text-xl font-medium mb-4">
                Worksheet Header
              </h1>
              <div>
                <div class="flex items-center mb-4">
                  ...
                  <label
                    ...
                    class="ml-2 text-sm font-medium text-[#525252]"
                  >
                    Worksheet Title
                  </label>
                </div>
            ...
            <div className=" mt-4 flex items-center gap-5">
              <div className=" w-full">
                ...
                <select
                  id="area"
                  name="area"
                  class="bg-[#F5F5F5] border border-gray-300 text-gray-900 mt-2 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3 py-2  "
                >
                  <option selected value="CA">
                    Select area of need
                  </option>
            ...
            <div className=" flex items-center justify-between mt-4 mb-4">
              <div class="flex items-center ">
                ...
                <label
                  for="default-checkbox"
                  class="ml-2 text-sm font-medium text-[#1f1f1f]"
                >
                  Student Info
                </label>
              </div>
              <div className="flex items-center gap-2">
                <span class=" text-sm font-medium text-[#1f1f1f]">
                  Every Page
                </span>
            ...
            <button className=" py-3 w-full rounded-lg bg-[#DFFCFF] text-[#555555]  mt-8 font-medium">
              Add New Field
            </button>
            ...
            <button
              ...
              className=" py-3 w-full rounded-lg border border-[#A9F8FD] text-[#555555]  mt-8 font-medium flex items-center justify-center gap-2"
            >
              <RiTodoLine />
              Add
            </button>
            ...
            <button
              onClick={() => setUpdate(!update)}
              className=" py-3 w-full rounded-lg bg-[#A9F8FD] text-[#555555]  mt-8 font-medium flex items-center justify-center gap-2"
            >
              <BsPrinter />
              Make Printable
            </button>
          ...
          <div className=" flex flex-col items-center">
            ...
            <div>
              <h1 className=" text-[#2B2B2B] text-2xl text-center font-medium mt-10">
                Worksheet Title
              </h1>
            </div>
